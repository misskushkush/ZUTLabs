...
int menu()
{
    ...
    while (true) {
        ...
        case 1: {
            ...
            std::cin >> cityName;
            station = make_unique<TrainStation>();
            country.insert(cityName, move(station));
        ...
        case 2: {
            std::cout << "Enter city name: ";
            std::cin >> cityName;
            station = make_unique<BusStation>();
            country.emplace(cityName, move(station));
        ...
        case 3: {
            ...
            if (station != nullptr) {
                ...
                do {
                    ...
                    case 7: {
                        if (train2[0] != nullptr) cout << *train2[0];
                        break;
                    }
                    case 8: {
                        cout << train2;
        ...
        case 6:
            ...
            country.addStationToCity(cityName, move(station));
